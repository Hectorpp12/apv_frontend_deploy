  ...
  useEffect(() => {
    const comprovarToken = async () => {
      try {
        ...
        setAlerta ({msg: 'Hubo un error cone el alerta', error: true})
      }
    }
    comprovarToken()
  }, [])
      ...
      <div>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
          ...
          <form onSubmit={ handleSubmit }>
            <div className="my-5">
              <label className="block text-gray-600 uppercase font-bold text-xl">Nuevo Password</label>
            ...
            <input type="submit" value="Guardar Nuevo Password" className="bg-indigo-700 mt-5 w-full py-3 px-10 text-white uppercase font-bold rounded-xl hover:cursor-pointer hover:bg-indigo-800 md:w-auto"/>
          </form>
