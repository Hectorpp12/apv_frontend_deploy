        ...
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="my-3">
              ...
              value={perfil.nombre || ''} onChange={e => setPerfil({...perfil, [e.target.name]: e.target.value})}/>
            </div>
            ...
            <input type="submit" value="Guardar Cambios" className="bg-indigo-700 hover:bg-indigo-500 transition-colors cursor-pointer uppercase font-bold w-full px-10 py-3 text-white rounded-lg m-5" />
